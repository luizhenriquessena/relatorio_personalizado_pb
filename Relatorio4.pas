...
{  if frmPrincipal.lblCodRelatorio.Caption = '10' then
  begin
    ...
    begin
    ShowMessage('Código TUSS inválido');
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
    ShowMessage('Favor inforar o número da fatura.');
    end;
  end;
  ...
  begin
    ...
    begin
    ShowMessage('Favor informar número de dias de atraso..');
    end;
  end;
  ...
  begin
    ...
    begin
    ShowMessage('Favor informar o código de geração.');
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        parametro := parametro + ' Beneficiário: ' + lblCodigo.Caption;
      end;
    ...
    begin
    ShowMessage('Favor informar número do boleto.');
    end;
  end;
...
begin
  ...
  if frmPrincipal.lblCodRelatorio.Caption = '10' then
  lblDataBase.Caption := 'Código TUSS: ';
...
begin
  ...
  begin
    ...
    qrpRelat59.qrlblTitulo.Caption := 'Relatório de Glosa - Pagamento ' + MesPag + ' - ' + Cod_Prest +' '+ Prestador;
  ...
  begin
    ...
    qrpRelat60.qrlblTitulo.Caption := 'Relatório de Glosa - Pagamento ' + MesPag + ' - ' + Prestador;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ShowMessage('Titular não encontrado');
        edtNome.Clear;
        edtCodigo.Clear;
        lblCodigo.Caption := 'X';
      end;
