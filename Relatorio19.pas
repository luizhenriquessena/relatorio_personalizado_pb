...
begin
  ...
  Close;
  SQL.Clear;
  SQL.Add('select distinct(descricao) tipo_internacao from im_tipo_internacao tp');
  Open;
  First;
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          SQL.Add('    and situacao = '+#39+'LIBERADO'+#39+' and guia not in (select ti.achar_guia(2,2,ci.cod_cirur) guia from im_cirur ci where ci.situacao in (1))');
