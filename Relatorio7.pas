...
begin
  ...
  begin
    ...
    GroupBox2.Caption := 'Período de datas';
    Label2.Caption := 'até';
    chkDtConciliacao.Visible := False;
    Med_DataBase.Visible := False;
    Med_DataFinal.Text := '  /  /    ';
  ...
  begin
    lblDia.Visible := False;
    edtDia.Visible := False;
    GroupBox2.Caption := 'Período de inclusão';
    Label2.Caption := 'até';
  ...
  begin
    lblDia.Visible := True;
    edtDia.Visible := True;
    lblDia.Caption := 'Diferença de dias';
    GroupBox2.Caption := 'Período de inclusão';
    Label2.Caption := 'até';
    chkDtConciliacao.Visible := False;
    chkDtConciliacao.Checked := False;
  ...
  begin
    ...
    GroupBox2.Caption := 'Período de cadastro';
    Label2.Caption := 'até';
    chkDtConciliacao.Visible := False;
    Med_DataBase.Visible := False;
    Med_DataFinal.Text := '  /  /    ';
  ...
  begin
    GroupBox2.Caption := 'Início de Vigência';
  end;
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        parametro := parametro + 'Conciliação: '+ Med_DataBase.Text;
      end;
